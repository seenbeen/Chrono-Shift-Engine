...
namespace Experimental { namespace Test1 {
    class TestStage : public CSEA::Core::Stage, public CSEA::Input::InputListener {
        ...
        // setting up our ui
        CSEA::Render::Viewport *uiViewport;
        CSEA::Render::Scene *uiScene;
        CSEA::Render::SceneManagerUI *uiSceneManager;
        CSEA::Render::UICamera *uiCam;

        // setting up our game scene
        CSEA::Render::Viewport *gameViewport;
        CSEA::Render::Scene *gameScene;
        CSEA::Render::SceneManager2D *gameSceneManager;
